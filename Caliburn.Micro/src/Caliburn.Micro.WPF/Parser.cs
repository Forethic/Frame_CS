...
{
    /// <summary>
    /// Parser text into a fully functional set of <see cref="TriggerBase"/> instances with <see cref="ActionMessage"/>.
    /// </summary>
    public static class Parser
    {
        ...
        /// <summary>
        /// Parses the special message text.
        /// </summary>
        ...
        public static ActionMessage CreateMessage(DependencyObject target, string messageText)
        {
            ...
            var closingParenthesisIndex = messageText.IndexOf(')');
