...
{
    /// <summary>
    /// A service that is capable of properly binding values to a method's parameters and creating instance of <see cref="IResult"/>
    /// </summary>
    public static class MessageBinder
    {
        ...
        /// <summary>
        /// Determine the parameters that a method should be invoked with.
        /// </summary>
        ...
        public static object[] DetermineParameter(ActionExecutionContext context, ParameterInfo[] requiredParameters)
        {
