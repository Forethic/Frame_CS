...
{
    /// <summary>
    /// Used by the framework to pull instances from an IoC container and inject dependencies into certain existing classes.
    /// </summary>
    public static class IoC
    {
        ...
        public static T Get<T>() => (T)GetInstance(typeof(T), null);
        ...
        /// <returns>The resolved instance.</returns>
        public static T Get<T>(string key) => (T)GetInstance(typeof(T), key);
    }
}